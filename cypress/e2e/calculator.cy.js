...
describe("계산기 앱 테스트", () => {
  ...
  xit("덧셈: 두 숫자를 입력하고 =버튼을 클릭하면 display에 연산의 결과값이 표시된다.", () => {
    calculate([1, 2, 3], "+", [4, 5, 6], "579");
  });

  xit("뺄셈: 두 숫자를 입력하고 =버튼을 클릭하면 display에 연산의 결과값이 표시된다.", () => {
    calculate([1, 2, 3], "-", [4, 5, 6], "-333");
  });

  xit("곱셈: 두 숫자를 입력하고 =버튼을 클릭하면 display에 연산의 결과값이 표시된다.", () => {
    calculate([1, 2, 3], "X", [4, 5, 6], "56088");
  });

  xit("나눗셈: 두 숫자를 입력하고 =버튼을 클릭하면 display에 연산의 결과값이 표시된다.", () => {
